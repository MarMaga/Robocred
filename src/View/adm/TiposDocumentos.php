...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="formTipo" method="post" action="TiposDocumentos.php">
                ...
                <div class="card">
                    <form action="TiposDocumentos.php" method="post">
        ...
        <!-- /.card -->
        <form action="TiposDocumentos.php" method="post" id="formAlt">
            <?php include_once 'modais/alterar_tipoDocumento.php'; ?>
        </form>
